...
$_format['list'] = array(
    ...
    'access_in_param' => array('id','name','sex','company','email'),
);
...
$_format['item_list'] = array(
    ...
    'frame' => array(
        'fields' => array('name','sex','company','email','project'),
        'fields_extra' => array(
            'tableone' => array('id','name','sex'),
            'col1' => array('id','lang'),
            'actions' => array('unical_id')
    ...
    'access_in_param' => array('id')
);


$_format['list_for->send'] = array(
    'from' => 'list',
    'access' => array(
        'select' => array('authorized'),
    ),
